...
func (_m *ArticleRepository) Update(article repo.ArticleData) (time.Time, error) {
	...
	var r0 time.Time
	var r1 error
	if rf, ok := ret.Get(0).(func(repo.ArticleData) (time.Time, error)); ok {
		return rf(article)
	}
	if rf, ok := ret.Get(0).(func(repo.ArticleData) time.Time); ok {
		r0 = rf(article)
	} else {
		r0 = ret.Get(0).(time.Time)
	}

	if rf, ok := ret.Get(1).(func(repo.ArticleData) error); ok {
		r1 = rf(article)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *ArticleRepository_Update_Call) Return(_a0 time.Time, _a1 error) *ArticleRepository_Update_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ArticleRepository_Update_Call) RunAndReturn(run func(repo.ArticleData) (time.Time, error)) *ArticleRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
